    ...
    <template #default>
      ...
      <div v-else class="flex flex-col items-center">
        <div v-if="!isPublishing" class="mb-4">
          Do you want to publish your unsynced lyrics of the song <strong>{{ title }} - {{ artistName }}</strong> to your current LRCLIB instance?
        </div>
        <div v-else class="mb-4">
          Publishing your unsynced lyrics of the song <strong>{{ title }} - {{ artistName }}</strong>...
        </div>
