    ...
    <div class="flex flex-col gap-8">
      <div>
        ...
        <div class="flex flex-col">
          <label class="block mb-2 child-label" for="lrclib-instance"
            >LRCLIB instance</label
          >
          <input
            id="lrclib-instance"
            type="text"
      ...
      <div>
        ...
        <div class="flex items-start">
          ...
          >
            <div class="flex flex-col">
              <span class="mb-0.5"
                >Try to embed the lyrics to the track files when possible</span
              >
              <span class="text-xs text-yellow-700 dark:text-yellow-400"
                >This option could corrupt your track files. Make sure to backup
                your library before enabling it.</span
              >
            </div>
          </CheckboxButton>
        </div>
      ...
      <div class="flex flex-col gap-1">
        <a href="#" class="link" @click="refreshLibrary"
          >Refresh my library for new changes...</a
        >
...
const beforeOpenHandler = async () => {
  ...
  console.log(
    skipTracksWithSyncedLyrics.value,
    skipTracksWithPlainLyrics.value,
  );
