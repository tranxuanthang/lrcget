<template>
  ...
  >
    <template v-if="props.track.syncedLyrics && props.track.plainLyrics">
        ...
        >
          <button
            ...
            :class="{
              ...
              'hover:bg-brave-90 dark:hover:bg-brave-10':
                lyricsType !== 'synced',
            }"
      ...
      <div
        v-if="lyricsType === 'synced'"
        class="grow rounded bg-brave-99 text-brave-30 dark:bg-brave-1 dark:text-brave-95 whitespace-pre-line p-4 overflow-scroll select-text"
      >
        {{ props.track.syncedLyrics }}
      </div>

      <div
        v-else-if="lyricsType === 'plain'"
        class="grow rounded bg-brave-99 text-brave-30 dark:bg-brave-1 dark:text-brave-95 whitespace-pre-line p-4 overflow-scroll select-text"
      >
    ...
    <div
      v-else-if="props.track.plainLyrics"
      class="grow rounded bg-brave-99 text-brave-30 dark:bg-brave-1 dark:text-brave-95 whitespace-pre-line p-4 overflow-scroll"
    >
      {{ props.track.plainLyrics }}
    </div>

    <div
      v-else-if="props.track.instrumental"
