  ...
  <transition name="slide-fade" mode="out-in">
    ...
    >
      <transition name="slide-fade" mode="out-in">
        ...
        >
          <div class="relative h-full">
            <div
              class="flex justify-center items-center h-6 w-full relative z-10"
            >
              <button
            ...
            >
              <p
                ...
                class="transition"
                :class="{
                  'font-bold text-brave-50 dark:text-brave-95':
                    currentIndex === index,
      ...
      >
        ...
        <transition name="slide-fade" mode="out-in">
          <div
            class="flex w-full justify-center items-center text-brave-30 dark:text-brave-95 text-sm grow"
            :key="currentLyrics"
          >
            {{ currentLyrics }}
          </div>
...
const updateCurrentLineElementOffset = (newCurrentIndex) => {
  ...
  const fullLyricsContainerEl = document.getElementById(
    "full-lyrics-container",
  );
  if (fullLyricsContainerEl) {
    const currentLyricsLine = Array.from(fullLyricsContainerEl.children)[
      newCurrentIndex
    ];
