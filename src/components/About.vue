      ...
      <div class="mb-6">
        ...
        <div class="text-sm">
          ...
          <template v-if="!isCheckingForUpdate && newestVersion">
            ...
            <div
              v-else
              class="font-bold text-green-600 flex flex-wrap gap-1 items-center"
            >
      ...
      <div class="mb-6">
        ...
        <div class="text-sm">
          <div class="mb-2">
            ...
            <div>
              <a
                href="https://github.com/sponsors/tranxuanthang"
                class="link"
                target="_blank"
              >
          ...
          <div class="mb-2">
            ...
            <div>
              <a
                href="https://www.buymeacoffee.com/thangtran"
                class="link"
                target="_blank"
              >
          ...
          <div class="mb-2">
            ...
            <div>
              <a
                href="https://paypal.me/tranxuanthang98"
                class="link"
                target="_blank"
              >
          ...
          <div class="mb-2">
            ...
            <CopyablePre
              >ltc1q7texq5qsp59gclqlwf6asrqmhm98gruvz94a48</CopyablePre
            >
          </div>
        </div>
      </div>
