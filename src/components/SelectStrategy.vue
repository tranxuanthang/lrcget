<template>
  <div class="flex flex-col justify-center items-center w-full h-full p-4">
    ...
    <div class="flex mb-4 gap-4 text-gray-200">
      ...
      >
        <div class="font-bold text-hoa-1400 mb-3">
          Create separate LRC files
        </div>
        <div class="text-sm text-hoa-1300">
          LRC lyrics files will be created in the same location with the music
      ...
      >
        <div class="font-bold text-hoa-1400 mb-3">
          Embed lyrics to music files
        </div>
        <div class="text-sm text-hoa-1300">
          Lyrics will be embedded to music files through SYLT tag (mp3) or
          LYRICS tag (flac). Limited players support.
        </div>
      </button>
    </div>
...
const progressStep = () => {
  emit(
    ...
    isCreateLRC.value,
    isEmbed.value,
    skipTracksHaveExistingLyrics.value,
  );
};
